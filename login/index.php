    ...
    <body>
        ...
        <div class="login">
            ...
            <form action="authenticate.php" method="post" class="form login-form">
                ...
                <label class="form-label" for="username">Avean-ID</label>
                <div class="form-group">
                    ...
                    <input class="form-input" type="text" name="username" placeholder="Avean-ID" id="username" required>
                </div>
                ...
                <p class="register-link">Don't have an account? <a href="#apply" class="form-link">Apply Now</a></p>
                <p class="forgot-link">Forgot your password? <a href="#forgot" class="form-link">Reset</a></p>
                <p class="back-link">Wrong Page? <a href="/kavn.v1/index.html" class="form-link">Go back</a></p>
